...
class Register extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch("https://peaceful-headland-10602.herokuapp.com/register", {
      method: "post",
            ...
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mt3">
                ...
                <input 
                  ...
                  className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="username" id="username" 
                />
              </div>
              <div className="mv3">
